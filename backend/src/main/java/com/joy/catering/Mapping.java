...
public final class Mapping {
 ...
 public static FeedbackOut feedback(Feedback f){return new FeedbackOut(f.getId(), f.getBooking().getId(), f.getBooking().getReference(), f.getRating(), f.getComment(), f.getCategories(), f.getStaffResponse(), f.getStatus(), f.getCreatedAt(), f.getUpdatedAt());}
 public static StaffFeedbackOut staffFeedback(Feedback f){var p=f.getCustomer().getProfile();return new StaffFeedbackOut(f.getId(), f.getBooking().getId(), f.getBooking().getReference(), f.getRating(), f.getComment(), f.getCategories(), f.getStaffResponse(), f.getStatus(), f.getCreatedAt(), f.getUpdatedAt(), f.getCustomer().getId(), p.getFullName(), f.getCustomer().getEmail(), p.getMobileNumber());}
 private Mapping(){}
}
